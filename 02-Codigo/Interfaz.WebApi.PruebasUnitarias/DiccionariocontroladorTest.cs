...
namespace Babel.Interfaz.WebApi.PruebasUnitarias
{
    ...
    public class DiccionarioControladorTest
    {
        ...
        private CrearUnDiccionarioPeticion diccionarioPeticion=CrearUnDiccionarioPeticion.CrearNuevaInstancia();
        ...
        public DiccionarioControladorTest() {
            ...
            var crearUnDiccionarioRespuesta = appModelosRespuesta.CrearUnDiccionarioRespuesta.CrearNuevaInstancia();
        ...
        public void PruebaCrearUnDiccionarioRetornaDiccionarioConRelaciones() 
        {
            ...
            var diccionarioDominioPrueba = JsonConvert.SerializeObject( Diccionario.CrearNuevoDiccionario());
            ...
            //var respuesta = this.appMantenimientoDiccionario.CrearUnDiccionario()
